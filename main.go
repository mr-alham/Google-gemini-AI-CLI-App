		...
		CodeBlock: ansi.StyleCodeBlock{
			StyleBlock: ansi.StyleBlock{
				StylePrimitive: ansi.StylePrimitive{
					...
					BlockPrefix: "\033[0;38;5;204m" + strings.Repeat("─", (width/2)-14) + " </> " + strings.Repeat("─", (width/2)-10) + "\033[0;37m\n",
					BlockSuffix: "\033[0;38;5;204m" + strings.Repeat("─", (width/2)-13) + " 🝔 " + strings.Repeat("─", (width/2)-10) + "\033[0;37m\n",
					Color:       stringPtr("244"),
				},
